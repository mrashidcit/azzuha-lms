  ...
  <section id="contact-page">
    <div class="container">
      ...
      <div class="row contact-wrap" style='margin-left: 350px;'>
        ...
        <form class="contact-form" name="add-course" method="post" action="/update-subject">
          {!! csrf_field() !!}
          <div class="col-sm-5 col-sm-offset-1">
            <div class="form-group">
              <label>Subject Title *</label>
              <input type="hidden" name="id" value="{{$id}}" class="form-control" >
              <input type="text" name="name" value="{{$name}}" class="form-control" required="required" placeholder="Please Enter your Subject Title">
            </div>
            <div class="form-group">
