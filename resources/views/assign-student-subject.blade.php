  ...
  <section id="contact-page">
    <div class="container">
      ...
      <?php
        $t_options='';
      ?>
      @foreach ($students as $t_key => $t_value)
        <?php
          if($student_id == $t_value->id && $student_id != ''){
            $selected = 'selected';
          }
          else{
            $selected = '';
      ...
      <div class="row contact-wrap">
        ...
        <form class="contact-form" name="add-teacher" method="post" action="/store-student-subject" >
          {!! csrf_field() !!}
          <div class="col-sm-5 col-sm-offset-1">

            <div class="form-group">
              <label>Teachers *</label>
              <select type="text" name="st_id" class="form-control" >
                <?php echo $t_options;?>
              </select>
            </div>
            <div class="form-group">
